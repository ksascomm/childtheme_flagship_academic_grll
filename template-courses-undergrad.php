...
<?php // Load Zebra Curl
	...
	//Set query sting variables
		...
		$subdepartment = get_the_program_slug($post);
		$fall = 'fall%202014';
	...
	//Course display callback function
		function display_courses($result) {
		    ...
		    // show everything
		    echo '<li class="' . $term .' ' . $subdept . '" id="' . $clean_course_number . '"><div class="title"><h5><span class="course-number">' . $course_number . '</span> - ' . $title . '</h5></div>';
