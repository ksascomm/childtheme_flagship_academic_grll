...
<header>
		<div class="row show-for-small" id="mobile-header">
			...
			<h2 class="white" align="center"><?php echo $program_name . ' Program'; ?></h2>
		...
		<div class="row hide-for-small hide-for-print" id="site_title">
			...
			<div class="nine columns">	
				<a href="<?php echo site_url(); ?>"><h1 class="white"><span class="small"><?php echo get_bloginfo ( 'title' ); ?></span>					<?php echo $program_name . ' Program'; ?></h1></a>
			</div>
		</div>
		<div class="row hide-for-print">
			<?php wp_nav_menu( array( 
